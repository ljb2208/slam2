...
#ifndef __MATCHERNEW_H__
#define __MATCHERNEW_H__
...
public:
  ...
  MatcherNew(parameters param, Matches* matches);
...
private:
  ...
  bool getSmallDescriptor (bool left, const int32_t &u,const int32_t &v,const int32_t &c, uint8_t *desc_addr);
  void computeDescriptors (uint8_t* I_du,uint8_t* I_dv,const int32_t bpl,std::vector<Matches::maximum> &maxima, bool rightImage);
  void saveSmallDescriptor (bool left, const int32_t &u,const int32_t &v,const int32_t &c, uint8_t *desc_addr);
  ...
  // parabolic fitting
  bool parabolicFitting(bool left, const uint8_t* I1_du,const uint8_t* I1_dv,const int32_t* dims1,
  ...
  int32_t matchId;
  std::vector<MatcherNew::range>   ranges;
